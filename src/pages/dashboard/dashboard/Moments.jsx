...
const Moments = () => {
    ...
    const fetchActions = async () => {
        try {
            const response = await axiosInstance.get("/moment/")
            const data = await response?.data
            setMomentsList(data?.moments);
        } catch (error) {
    ...
    return (
        <div>
            <AdminDashboard />
            <div className="pl-20 pt-12 bg-gray-200 md:pl-72 md:pt-32 pb-5">
                                ...
                                <tbody >
                                    {
                                        momentsList?.map((moment, index) => {
                                            // console.log(moment?.userId?.name);
                                            return (
                                            ...
                                            <img src="" alt="" className="w-10" />
                                                    ...
                                                    <td className="p-2 border-r">{moment?.userId?.name}</td>
